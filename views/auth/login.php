...
<body>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (!regForm) return; // Salir si no existe el formulario de registro
            ...
            // Validación del teléfono - con código de país +507
            if (phoneInput) {
            ...
            if (taxIdProvinciaInput && taxIdNumeroInput && taxIdVerificadorInput && taxIdHiddenInput) {
                ...
                // Campo 3: Verificador (4 o 5 dígitos)
                ...
                function updateFullTaxId() {
                    ...
                    const provincia = taxIdProvinciaInput.value ? taxIdProvinciaInput.value.padStart(2, '0') : '';
            ...
            if (regForm) {
                regForm.addEventListener('submit', function(e) {
                    ...
                    if ((taxIdProvinciaInput && taxIdProvinciaInput.value) || 
                        (taxIdNumeroInput && taxIdNumeroInput.value) || 
                        (taxIdVerificadorInput && taxIdVerificadorInput.value)) {
                        
                        const provincia = taxIdProvinciaInput ? taxIdProvinciaInput.value.padStart(2, '0') : '';
                        const numero = taxIdNumeroInput ? taxIdNumeroInput.value : '';
                        const verificador = taxIdVerificadorInput ? taxIdVerificadorInput.value : '';
                        
                        if (!provincia || provincia.length !== 2) {
                            hasErrors = true;
                            if (taxIdProvinciaInput) {
